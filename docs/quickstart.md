...
A non secured FHIR server is important to support testing with a CDS Service. When the EHR moves a hook to production the system to is expected to follow the guidelines in the [security](specification/1.0/#security-and-safety) requirements.
