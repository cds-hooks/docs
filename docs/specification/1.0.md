...
`topic` | OPTIONAL | *[FHIR Coding](http://hl7.org/fhir/datatypes.html#coding)* | A "FHIR Coding" json object containing a descriptive topic related to the content of the card. A topic provides a high-level categorization that can be useful for filtering and searching.
