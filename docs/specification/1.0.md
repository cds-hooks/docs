...
`preference` | OPTIONAL | *string* | Allows a service to indication how preferable this suggestion is from among all the available suggestions on the card. Allowed values are: `recommended`, and `alternate`.
