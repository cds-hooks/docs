...
`topic` | OPTIONAL | *object* | A **Topic** describes the content of the card by providing a high-level categorization that can be useful for filtering and searching.

A **Topic** contains a `code`, `system` and `label`.
